...
*/
    ...
    private static void removeInfo() {
        ...
        if (person.containsKey(silinecekTc)) {//1. adım
            ...
            removeInfo();
        }//kullanıcı, silinenTc ye sahip şahıs olmadığı  için tekrar tc girişi için
        selectOption();
    }
    ...
    private static void getInfo() {
        ...
        if (person.containsKey(arananTc)) {
            ...
            System.out.println("aradiginiz tc sahip sahis yoktur.\n tekrar deneyin");
            getInfo();
        }//kullanıcı, arananTc ye sahip şahıs olmadığı  için tekrar tc girişi için //kullanıcı var olan tc girdiği için tekrar tc girişi için saveInfo() metoda geri gönderdik. metoda geri gönderdik.
        selectOption();
    }
