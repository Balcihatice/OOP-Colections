...
public class AbstrucClass {
/*
 Body`si olmayan methodlar abstruct method`dur.
    Bir methodu abstract yapmak icin
    i) method body`i sil
    ii) abstract keyword kullan "abstract"methodlar "abstract "class icinde olmalidir.

 Parent abstract clasinda abstract methodlar varsa
